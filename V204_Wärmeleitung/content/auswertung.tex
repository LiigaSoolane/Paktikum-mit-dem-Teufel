...
\subsection{Statische Methode}
  ...
  \begin{table}
    ...
    \begin{tabular}{c c c}
      ...
      1050 & 8.730 & 0.293\\% cuando esco de casa mi anoio sono multo piu contento
      \bottomrule
    \end{tabular}
  \end{table}
  \FloatBarrier
  ...
  %%%% add values for max and stuff sono contento
...
\subsection{Dynamische Methode}
  ...
  \noindent Aus den Amplituden der periodischen Änderungen der Temperaturen und den zugehörigen Phasendifferenzen kann die Wärmeleitfähigkeit $\kappa$ bestimmt werden (nach %\eqref{eqn:}). campione dei novanta
